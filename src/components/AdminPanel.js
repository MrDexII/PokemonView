                ...
                <td>
                  <Select
                    ...
                    onChange={(event, event2) =>
                      handleSelectChange(event, event2, user.user_id)
                    }
                    options={roles.map(mapRoleLabels)}
                  />
                </td>
                <td>
                  <button onClick={(event) => handleUpdateUser(user.user_id)}>
                    Update
                  </button>
                </td>
                <td>
                  <button onClick={(event) => handleDeleteUser(user.user_id)}>
                    Delete
                  </button>
                </td>
              </tr>
